...
<html dir="rtl">
    ...
    <body>
      <h4 class="text-center pt-3 mr-4 font-weight-bold"> نسبة مرض السكري بين المتقدمين لفحص قبل الزواج</h4>
...
$limit = isset($_POST["limit-records"]) ? $_POST["limit-records"] : 100;
	...
	$start = ($page - 1) * $limit;
        ...
        $result = $conn->query("SELECT governorate,count(id) as total,sum(case when gender = 'أنثى' then 1 else 0 end) as Female,sum(case when gender = 'ذكر' then 1 else 0 end) as Male,sum(case when diabetesCheck <= 70 then 1 else 0 end) as totallow,sum(case when diabetesCheck <= 70 and gender = 'أنثى' then 1 else 0 end) as Femalelow,sum(case when diabetesCheck <= 70 and gender = 'ذكر' then 1 else 0 end) as Malelow,sum(case when diabetesCheck BETWEEN 71 and 140 then 1 else 0 end) as totalnormal,sum(case when diabetesCheck BETWEEN 71 and 140 and gender = 'أنثى' then 1 else 0 end) as Femalenormal,sum(case when diabetesCheck BETWEEN 71 and 140 and gender = 'ذكر' then 1 else 0 end) as Malenormal,sum(case when diabetesCheck BETWEEN 141 and 200 then 1 else 0 end) as totalrisk,sum(case when diabetesCheck BETWEEN 141 and 200 and gender = 'أنثى' then 1 else 0 end) as Femalerisk,sum(case when diabetesCheck BETWEEN 141 and 200 and gender = 'ذكر' then 1 else 0 end) as Malerisk,sum(case when diabetesCheck > 200 then 1 else 0 end) as totalpatient,sum(case when diabetesCheck > 200 and gender = 'أنثى' then 1 else 0 end) as Femalepatient,sum(case when diabetesCheck > 200 and gender = 'ذكر' then 1 else 0 end) as Malepatient FROM users where governorate = '$governorate' and date between '$stdate' AND '$endate' GROUP by governorate order by governorate LIMIT $start,$limit");
	$customers = $result->fetch_all(MYSQLI_ASSOC);
            }
          else if($stdate != '' && $endate != '' && $governorate = 'none'){
$result = $conn->query("SELECT governorate,count(id) as total,sum(case when gender = 'أنثى' then 1 else 0 end) as Female,sum(case when gender = 'ذكر' then 1 else 0 end) as Male,sum(case when diabetesCheck <= 70 then 1 else 0 end) as totallow,sum(case when diabetesCheck <= 70 and gender = 'أنثى' then 1 else 0 end) as Femalelow,sum(case when diabetesCheck <= 70 and gender = 'ذكر' then 1 else 0 end) as Malelow,sum(case when diabetesCheck BETWEEN 71 and 140 then 1 else 0 end) as totalnormal,sum(case when diabetesCheck BETWEEN 71 and 140 and gender = 'أنثى' then 1 else 0 end) as Femalenormal,sum(case when diabetesCheck BETWEEN 71 and 140 and gender = 'ذكر' then 1 else 0 end) as Malenormal,sum(case when diabetesCheck BETWEEN 141 and 200 then 1 else 0 end) as totalrisk,sum(case when diabetesCheck BETWEEN 141 and 200 and gender = 'أنثى' then 1 else 0 end) as Femalerisk,sum(case when diabetesCheck BETWEEN 141 and 200 and gender = 'ذكر' then 1 else 0 end) as Malerisk,sum(case when diabetesCheck > 200 then 1 else 0 end) as totalpatient,sum(case when diabetesCheck > 200 and gender = 'أنثى' then 1 else 0 end) as Femalepatient,sum(case when diabetesCheck > 200 and gender = 'ذكر' then 1 else 0 end) as Malepatient FROM users where date between '$stdate' AND '$endate' GROUP by governorate order by governorate");
	$customers = $result->fetch_all(MYSQLI_ASSOC); 
          }
        else{
           $result = $conn->query("SELECT governorate,count(id) as total,sum(case when gender = 'أنثى' then 1 else 0 end) as Female,sum(case when gender = 'ذكر' then 1 else 0 end) as Male,sum(case when diabetesCheck <= 70 then 1 else 0 end) as totallow,sum(case when diabetesCheck <= 70 and gender = 'أنثى' then 1 else 0 end) as Femalelow,sum(case when diabetesCheck <= 70 and gender = 'ذكر' then 1 else 0 end) as Malelow,sum(case when diabetesCheck BETWEEN 71 and 140 then 1 else 0 end) as totalnormal,sum(case when diabetesCheck BETWEEN 71 and 140 and gender = 'أنثى' then 1 else 0 end) as Femalenormal,sum(case when diabetesCheck BETWEEN 71 and 140 and gender = 'ذكر' then 1 else 0 end) as Malenormal,sum(case when diabetesCheck BETWEEN 141 and 200 then 1 else 0 end) as totalrisk,sum(case when diabetesCheck BETWEEN 141 and 200 and gender = 'أنثى' then 1 else 0 end) as Femalerisk,sum(case when diabetesCheck BETWEEN 141 and 200 and gender = 'ذكر' then 1 else 0 end) as Malerisk,sum(case when diabetesCheck > 200 then 1 else 0 end) as totalpatient,sum(case when diabetesCheck > 200 and gender = 'أنثى' then 1 else 0 end) as Femalepatient,sum(case when diabetesCheck > 200 and gender = 'ذكر' then 1 else 0 end) as Malepatient FROM users where governorate = '$governorate' GROUP by governorate order by governorate LIMIT $start,$limit");
	$customers = $result->fetch_all(MYSQLI_ASSOC); 
        }
    }
else{
$result = $conn->query("SELECT governorate,count(id) as total,sum(case when gender = 'أنثى' then 1 else 0 end) as Female,sum(case when gender = 'ذكر' then 1 else 0 end) as Male,sum(case when diabetesCheck <= 70 then 1 else 0 end) as totallow,sum(case when diabetesCheck <= 70 and gender = 'أنثى' then 1 else 0 end) as Femalelow,sum(case when diabetesCheck <= 70 and gender = 'ذكر' then 1 else 0 end) as Malelow,sum(case when diabetesCheck BETWEEN 71 and 140 then 1 else 0 end) as totalnormal,sum(case when diabetesCheck BETWEEN 71 and 140 and gender = 'أنثى' then 1 else 0 end) as Femalenormal,sum(case when diabetesCheck BETWEEN 71 and 140 and gender = 'ذكر' then 1 else 0 end) as Malenormal,sum(case when diabetesCheck BETWEEN 141 and 200 then 1 else 0 end) as totalrisk,sum(case when diabetesCheck BETWEEN 141 and 200 and gender = 'أنثى' then 1 else 0 end) as Femalerisk,sum(case when diabetesCheck BETWEEN 141 and 200 and gender = 'ذكر' then 1 else 0 end) as Malerisk,sum(case when diabetesCheck > 200 then 1 else 0 end) as totalpatient,sum(case when diabetesCheck > 200 and gender = 'أنثى' then 1 else 0 end) as Femalepatient,sum(case when diabetesCheck > 200 and gender = 'ذكر' then 1 else 0 end) as Malepatient FROM users GROUP by governorate ORDER by governorate LIMIT $start,$limit");
	$customers = $result->fetch_all(MYSQLI_ASSOC);       
}
...
if($page < 1){
			...
			<table id="tblData" class="table table-striped table-bordered">
	           ...
	           <tr>
                   ...
                   <th class="text-center" style="word-wrap: break-word;" colspan="3">الإجمالى</th>
                        <th class="text-center" style="word-wrap: break-word;" colspan="3">منخفض</th>
    ...
    <td><?php echo $customer['Malelow'];?></td>
      <td><?php echo $customer['Femalelow'];?></td>                            
         <td><?php echo $customer['totallow'];?></td>
    ...
    <td><?php echo $customer['Malepatient'];?></td>
        <td><?php echo $customer['Femalepatient'];?></td>
                                  <td><?php echo $customer['totalpatient'];?></td>
